package  com.mybo.component.list
{
	...
	public class ScrollableList extends Sprite
	{
		 ...
		 *特殊item的位移 
		 */
		public var itemWidthDisplacement:Number = 0;
		public var itemHeightDisplacement:Number = 0 ;
...
//				needUpDateitems= null;
		...
		public function set dataProvider(value:Array):void
		{
			...
			{ 
				if(itemWidthDisplacement !=0)dataProvider[i].itemWidthDisplacement =  itemWidthDisplacement;
				if(itemHeightDisplacement !=0)dataProvider[i].itemHeightDisplacement =  itemHeightDisplacement;
